...
public class WhiteBalanceReader implements ExifTagReader {

	private static final String tagName = "White Balance";
	...
	public void readTag(Tag tag, FileData data) throws MetadataException {
		String whiteBalanec = tag.getDescription();
		data.setWeissabgleich(whiteBalanec);
	}

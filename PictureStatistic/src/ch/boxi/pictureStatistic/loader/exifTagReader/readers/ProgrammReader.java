...
public class ProgrammReader implements ExifTagReader {

	private static final String tagName = "Exposure Program";
	@Override
	...
	public void readTag(Tag tag, FileData data) throws MetadataException {
		String programm = tag.getDescription();
		data.setProgram(programm);
	}
